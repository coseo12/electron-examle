...
export default class Go {
  constructor(global) {
    ...
    if (!this.global.require && typeof require !== 'undefined') {
      this.global.require = require;
    }

    if (!this.global.fs && this.global.require) {
      const fs = require('fs');
      if (
        typeof fs === 'object' &&
        fs !== null &&
    ...
    if (!this.global.TextEncoder && this.global.require) {
    ...
    if (!this.global.TextDecoder && this.global.require) {
